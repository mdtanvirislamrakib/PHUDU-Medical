...
const DoctorDetails = () => {
    ...
    return (
        <>
            {
                loading ? (<span className="loading loading-infinity w-10 md:w-14 lg:w-24 text-indigo-600 min-h-screen flex items-center justify-center mx-auto my-auto"></span>) : (<div className='w-full lg:w-10/12 mx-auto my-5 space-y-8'>
                        ...
                        <div className='p-5 lg:px-10 lg:py-5'>
                            ...
                            <div className='space-y-2 mt-3'>
                                ...
                                <div className='flex items-center justify-between'>
                                    ...
                                    {!isAvailable && <p className='bg-sky-50 lg:px-3 px-2 py-1 lg:py-2 text-xs lg:text-lg text-red-500 font-semibold border border-red-400 rounded-4xl'>Unavailable</p>}
                                ...
                                <div className='md:flex items-center gap-2 bg-gray-50 border border-orange-200 text-center lg:text-sm justify-center rounded-3xl py-1 text-xs text-orange-400 mt-4 hidden '>
